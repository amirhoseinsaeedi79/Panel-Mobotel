      ...
      <div className="mx-1 flex w-[98%] flex-col rounded-xl shadow-2xl md:w-[90%] lg:w-[60%]">
        ...
        <div className="rounded-b-xl bg-white p-3">
          <div className="mb-3">
            ...
            <p className="blue mt-1 rounded-xl p-3">{prop.item}</p>
          </div>
          <form className="flex-col-center md:flex-row-center w-full">
            ...
            <textarea
              ref={answerDate}
              className="mx-3 mb-3 mt-1 h-[150px] w-full rounded-xl border-[3px] border-blue p-3 focus:outline-blue md:w-7/12"
            ></textarea>
