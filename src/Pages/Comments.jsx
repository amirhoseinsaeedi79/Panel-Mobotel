...
export default function Comments() {
  ...
  const Allcomment=[
    {id:1 ,name:'amir',text:'ممنون از زحمات شما امیرحسین عزیز خداقوت'},
    {id:2 ,name:'ali',text:'خیلی عااااااااااالی بود'}
  ]
                    ...
                    {Allcomment.map((com) => (
                      <tr key={com.id} className="bg-gray-100 vazir-bold ">
                        ...
                        <td className="text-sm text-gray-900  px-6 py-4 whitespace-nowrap flex-row-center vazir-bold">
                          ...
                          <button  onClick={()=>answerHandler(com.text)} className="px-5 py-2 border-[2.5px] border-blue text-blue  hover:bg-blue hover:text-white rounded-xl mr-5  ">
                            پاسخ
                          </button>
